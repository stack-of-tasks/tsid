...
namespace tsid
{
  namespace python
  {
    ...
    void exposeMathUtils()
    {
        ...
        bp::def("SE3ToVector", &SE3ToVector_1, bp::args("M"), "Convert the input SE3 object M to a 12D vector of floats [X,Y,Z,R11,R12,R13,R14,...] and return the vector");
        ...
        bp::def("vectorToSE3", &vectorToSE3_1, bp::args("vec"), "Convert the input 12D vector of floats [X,Y,Z,R11,R12,R13,R14,...] vec to a SE3 object and return the SE3 object");
    }
  }
}
