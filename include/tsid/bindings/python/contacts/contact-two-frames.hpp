...
namespace tsid
{
  ...
  {    
    ...
    : public boost::python::def_visitor< ContactTwoFramesPythonVisitor<ContactTwoFrames> >
    {
      ...
      void visit(PyClass& cl) const
      {
        ...
        .def("computeMotionTask", &ContactTwoFramesPythonVisitor::computeMotionTask, bp::args("t", "q", "v", "data"))
        .def("computeForceTask", &ContactTwoFramesPythonVisitor::computeForceTask, bp::args("t", "q", "v", "data"))
        .def("computeForceRegularizationTask", &ContactTwoFramesPythonVisitor::computeForceRegularizationTask, bp::args("t", "q", "v", "data"))
        
        .add_property("getForceGeneratorMatrix", bp::make_function(&ContactTwoFramesPythonVisitor::getForceGeneratorMatrix, bp::return_value_policy<bp::copy_const_reference>()))
        
        .def("getNormalForce", &ContactTwoFramesPythonVisitor::getNormalForce, bp::arg("vec"))
        ...
        .add_property("Kp", bp::make_function(&ContactTwoFramesPythonVisitor::Kp, bp::return_value_policy<bp::copy_const_reference>()))
        .add_property("Kd", bp::make_function(&ContactTwoFramesPythonVisitor::Kd, bp::return_value_policy<bp::copy_const_reference>()))
        .def("setKp", &ContactTwoFramesPythonVisitor::setKp, bp::arg("Kp"))
        .def("setKd", &ContactTwoFramesPythonVisitor::setKd, bp::arg("Kd"))

        .def("useLocalFrame", &ContactTwoFramesPythonVisitor::useLocalFrame, bp::arg("local_frame"))

        .def("setContactNormal", &ContactTwoFramesPythonVisitor::setContactNormal, bp::args("vec"))
        .def("setFrictionCoefficient", &ContactTwoFramesPythonVisitor::setFrictionCoefficient, bp::args("friction_coeff"))
        .def("setMinNormalForce", &ContactTwoFramesPythonVisitor::setMinNormalForce, bp::args("min_force"))
        .def("setMaxNormalForce", &ContactTwoFramesPythonVisitor::setMaxNormalForce, bp::args("max_force"))
        .def("setReference", &ContactTwoFramesPythonVisitor::setReference, bp::args("SE3"))
        .def("setForceReference", &ContactTwoFramesPythonVisitor::setForceReference, bp::args("f_vec"))
        .def("setRegularizationTaskWeightVector", &ContactTwoFramesPythonVisitor::setRegularizationTaskWeightVector, bp::args("w_vec"))
        ;
      }
      ...
      static void expose(const std::string & class_name)
      {
        ...
        bp::class_<ContactTwoFrames>(class_name.c_str(),
                          doc.c_str(),
                          bp::no_init)
