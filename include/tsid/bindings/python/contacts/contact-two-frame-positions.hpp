...
namespace tsid
{
  ...
  {    
    ...
    : public boost::python::def_visitor< ContactTwoFramePositionsPythonVisitor<ContactTwoFramePositions> >
    {
      ...
      void visit(PyClass& cl) const
      {
        ...
        .add_property("n_motion", &ContactTwoFramePositions::n_motion, "return number of motion")
        .add_property("n_force", &ContactTwoFramePositions::n_force, "return number of force")
        .add_property("name", &ContactTwoFramePositionsPythonVisitor::name, "return name")
        .def("computeMotionTask", &ContactTwoFramePositionsPythonVisitor::computeMotionTask, bp::args("t", "q", "v", "data"))
        .def("computeForceTask", &ContactTwoFramePositionsPythonVisitor::computeForceTask, bp::args("t", "q", "v", "data"))
        .def("computeForceRegularizationTask", &ContactTwoFramePositionsPythonVisitor::computeForceRegularizationTask, bp::args("t", "q", "v", "data"))
        
        .add_property("getForceGeneratorMatrix", bp::make_function(&ContactTwoFramePositionsPythonVisitor::getForceGeneratorMatrix, bp::return_value_policy<bp::copy_const_reference>()))
        
        .def("getNormalForce", &ContactTwoFramePositionsPythonVisitor::getNormalForce, bp::arg("vec"))
        .add_property("getMinNormalForce", &ContactTwoFramePositions::getMinNormalForce)
        .add_property("getMaxNormalForce", &ContactTwoFramePositions::getMaxNormalForce)
        
        .add_property("Kp", bp::make_function(&ContactTwoFramePositionsPythonVisitor::Kp, bp::return_value_policy<bp::copy_const_reference>()))
        .add_property("Kd", bp::make_function(&ContactTwoFramePositionsPythonVisitor::Kd, bp::return_value_policy<bp::copy_const_reference>()))
        .def("setKp", &ContactTwoFramePositionsPythonVisitor::setKp, bp::arg("Kp"))
        .def("setKd", &ContactTwoFramePositionsPythonVisitor::setKd, bp::arg("Kd"))

        .def("useLocalFrame", &ContactTwoFramePositionsPythonVisitor::useLocalFrame, bp::arg("local_frame"))

        .def("setContactNormal", &ContactTwoFramePositionsPythonVisitor::setContactNormal, bp::args("vec"))
        .def("setFrictionCoefficient", &ContactTwoFramePositionsPythonVisitor::setFrictionCoefficient, bp::args("friction_coeff"))
        .def("setMinNormalForce", &ContactTwoFramePositionsPythonVisitor::setMinNormalForce, bp::args("min_force"))
        .def("setMaxNormalForce", &ContactTwoFramePositionsPythonVisitor::setMaxNormalForce, bp::args("max_force"))
        .def("setReference", &ContactTwoFramePositionsPythonVisitor::setReference, bp::args("SE3"))
        .def("setForceReference", &ContactTwoFramePositionsPythonVisitor::setForceReference, bp::args("f_vec"))
        .def("setRegularizationTaskWeightVector", &ContactTwoFramePositionsPythonVisitor::setRegularizationTaskWeightVector, bp::args("w_vec"))
        ;
      }
      ...
      static void useLocalFrame (ContactTwoFramePositions & self, const bool local_frame) {
      ...
      static void setReference(ContactTwoFramePositions & self, const pinocchio::SE3 & ref){
      ...
      static void expose(const std::string & class_name)
      {
        ...
        bp::class_<ContactTwoFramePositions>(class_name.c_str(),
                          doc.c_str(),
                          bp::no_init)
