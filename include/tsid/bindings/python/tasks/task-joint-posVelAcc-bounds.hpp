  ...
  namespace python
  {
    ...
    : public boost::python::def_visitor< TaskJointPosVelAccBoundsPythonVisitor<Task> >
    {
      ...
      void visit(PyClass& cl) const
      {
        ...
        .def("setVerbose",  &TaskJointPosVelAccBoundsPythonVisitor::setVerbose, bp::args("verbose"))
        .def("setImposeBounds",  &TaskJointPosVelAccBoundsPythonVisitor::setImposeBounds, bp::args("impose_position_bounds", "impose_velocity_bounds", "impose_viability_bounds", "impose_acceleration_bounds"))
        .def("isStateViable",  &TaskJointPosVelAccBoundsPythonVisitor::isStateViable, (bp::arg("q"), bp::arg("dq"), bp::arg("verbose")=true))
        .def("computeAccLimitsFromPosLimits",  &TaskJointPosVelAccBoundsPythonVisitor::computeAccLimitsFromPosLimits, (bp::arg("q"), bp::arg("dq"), bp::arg("verbose")=true))
        .def("computeAccLimitsFromViability",  &TaskJointPosVelAccBoundsPythonVisitor::computeAccLimitsFromViability, (bp::arg("q"), bp::arg("dq"), bp::arg("verbose")=true))
        .def("computeAccLimits",  &TaskJointPosVelAccBoundsPythonVisitor::computeAccLimits, (bp::arg("q"), bp::arg("dq"), bp::arg("verbose")=true))
        .def("setMask",  &TaskJointPosVelAccBoundsPythonVisitor::setMask, bp::args("mask"))
        .add_property("getAccelerationBounds", bp::make_function(&TaskJointPosVelAccBoundsPythonVisitor::getAccelerationBounds, bp::return_value_policy<bp::copy_const_reference>()))
        .add_property("getVelocityBounds", bp::make_function(&TaskJointPosVelAccBoundsPythonVisitor::getVelocityBounds, bp::return_value_policy<bp::copy_const_reference>()))
        .add_property("getPositionLowerBounds", bp::make_function(&TaskJointPosVelAccBoundsPythonVisitor::getPositionLowerBounds, bp::return_value_policy<bp::copy_const_reference>()))
        .add_property("getPositionUpperBounds", bp::make_function(&TaskJointPosVelAccBoundsPythonVisitor::getPositionUpperBounds, bp::return_value_policy<bp::copy_const_reference>()))
      ...
      static void setImposeBounds(Task & self,
                                  bool impose_position_bounds,
                                  bool impose_velocity_bounds,
                                  bool impose_viability_bounds,
                                  bool impose_acceleration_bounds){
                            return self.setImposeBounds(impose_position_bounds, impose_velocity_bounds, impose_viability_bounds, impose_acceleration_bounds);
                           }
