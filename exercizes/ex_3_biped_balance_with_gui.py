...
def create_gui():
    ...
    button_contact_RF = Button(
        master, text="Break contact right foot", command=switch_contact_RF
    )
    button_contact_RF.pack(side=tk.LEFT)
    button_contact_LF = Button(
        master, text="Break contact left foot", command=switch_contact_LF
    )
    button_contact_LF.pack(side=tk.LEFT)
    Button(master, text="Toggle wireframe", command=toggle_wireframe_mode).pack(
        side=tk.LEFT
    )
